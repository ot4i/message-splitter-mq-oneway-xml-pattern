...
public class _jet_Logsubflow_0 implements JET2Template {
    ...
    private static final TagInfo _td_c_get_38_56 = new TagInfo("c:get", //$NON-NLS-1$
            38, 56,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_38_88 = new TagInfo("c:get", //$NON-NLS-1$
            38, 88,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        RuntimeTagElement _jettag_c_get_38_56 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_38_56); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_get_38_56.setRuntimeParent(null);
        _jettag_c_get_38_56.setTagInfo(_td_c_get_38_56);
        _jettag_c_get_38_56.doStart(context, out);
        _jettag_c_get_38_56.doEnd();
        RuntimeTagElement _jettag_c_get_38_88 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_38_88); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_get_38_88.setRuntimeParent(null);
        _jettag_c_get_38_88.setTagInfo(_td_c_get_38_88);
        _jettag_c_get_38_88.doStart(context, out);
        _jettag_c_get_38_88.doEnd();
        out.write("\" ");  //$NON-NLS-1$        
        out.write(NL);         
