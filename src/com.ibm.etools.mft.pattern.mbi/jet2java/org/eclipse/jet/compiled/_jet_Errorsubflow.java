...
public class _jet_Errorsubflow implements JET2Template {
    ...
    private static final TagInfo _td_c_get_66_96 = new TagInfo("c:get", //$NON-NLS-1$
            66, 96,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_72_41 = new TagInfo("c:get", //$NON-NLS-1$
            72, 41,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_77_40 = new TagInfo("c:get", //$NON-NLS-1$
            77, 40,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_82_25 = new TagInfo("c:get", //$NON-NLS-1$
            82, 25,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_83_55 = new TagInfo("c:get", //$NON-NLS-1$
            83, 55,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_83_91 = new TagInfo("c:get", //$NON-NLS-1$
            83, 91,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_choose_102_1 = new TagInfo("c:choose", //$NON-NLS-1$
            102, 1,
            new String[] {
            },
            new String[] {
    ...
    private static final TagInfo _td_c_otherwise_119_1 = new TagInfo("c:otherwise", //$NON-NLS-1$
            119, 1,
            new String[] {
            },
            new String[] {
            } );
    private static final TagInfo _td_c_if_130_9 = new TagInfo("c:if", //$NON-NLS-1$
            130, 9,
            new String[] {
                "test", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_134_22 = new TagInfo("c:get", //$NON-NLS-1$
            134, 22,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_134_60 = new TagInfo("c:get", //$NON-NLS-1$
            134, 60,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_135_19 = new TagInfo("c:get", //$NON-NLS-1$
            135, 19,
            new String[] {
                "select", //$NON-NLS-1$
            },
...
com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.PatternMessages messages = new com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.PatternMessages();
        ...
        out.write("      </nodes>");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("      <nodes xmi:type=\"ComIbmMQReply.msgnode:FCMComposite_1\" xmi:id=\"FCMComposite_1_4\" location=\"600,33\">");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write("      </nodes>");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("      <nodes xmi:type=\"ComIbmThrow.msgnode:FCMComposite_1\" xmi:id=\"FCMComposite_1_5\" location=\"632,127\"");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tmessageText=\"");  //$NON-NLS-1$        
        out.write( pattern.getString("com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.esql.10") );
        out.write(" ");  //$NON-NLS-1$        
        RuntimeTagElement _jettag_c_get_66_96 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_66_96); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_get_66_96.setRuntimeParent(null);
        _jettag_c_get_66_96.setTagInfo(_td_c_get_66_96);
        _jettag_c_get_66_96.doStart(context, out);
        _jettag_c_get_66_96.doEnd();
        out.write(" ");  //$NON-NLS-1$        
        out.write( pattern.getString("com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.esql.11") );
        out.write(" \">");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        while (_jettag_c_if_70_1.okToProcessBody()) {
            out.write("      <nodes xmi:type=\"ComIbmCompute.msgnode:FCMComposite_1\" xmi:id=\"FCMComposite_1_7\" location=\"464,204\" ");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("      computeExpression=\"esql://routine/");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_c_get_72_41 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_72_41); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_72_41.setRuntimeParent(_jettag_c_if_70_1);
            _jettag_c_get_72_41.setTagInfo(_td_c_get_72_41);
            _jettag_c_get_72_41.doStart(context, out);
            _jettag_c_get_72_41.doEnd();
            ...
            out.write("      </nodes>");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("      <nodes xmi:type=\"ComIbmFilter.msgnode:FCMComposite_1\" xmi:id=\"FCMComposite_1_8\" location=\"203,192\" ");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("      filterExpression=\"esql://routine/");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_c_get_77_40 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_77_40); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_77_40.setRuntimeParent(_jettag_c_if_70_1);
            _jettag_c_get_77_40.setTagInfo(_td_c_get_77_40);
            _jettag_c_get_77_40.doStart(context, out);
            _jettag_c_get_77_40.doEnd();
            ...
            out.write("      </nodes>");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("      <nodes xmi:type=\"ComIbmMQOutput.msgnode:FCMComposite_1\" xmi:id=\"FCMComposite_1_12\" location=\"562,203\" ");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("      queueManagerName=\"");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_c_get_82_25 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_82_25); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_82_25.setRuntimeParent(_jettag_c_if_70_1);
            _jettag_c_get_82_25.setTagInfo(_td_c_get_82_25);
            _jettag_c_get_82_25.doStart(context, out);
            _jettag_c_get_82_25.doEnd();
            out.write("\" ");  //$NON-NLS-1$        
            out.write(NL);         
            ...
            _jettag_c_get_83_18.setRuntimeParent(_jettag_c_if_70_1);
            _jettag_c_get_83_18.setTagInfo(_td_c_get_83_18);
            _jettag_c_get_83_18.doStart(context, out);
            _jettag_c_get_83_18.doEnd();
            RuntimeTagElement _jettag_c_get_83_55 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_83_55); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_83_55.setRuntimeParent(_jettag_c_if_70_1);
            _jettag_c_get_83_55.setTagInfo(_td_c_get_83_55);
            _jettag_c_get_83_55.doStart(context, out);
            _jettag_c_get_83_55.doEnd();
            RuntimeTagElement _jettag_c_get_83_91 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_83_91); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_83_91.setRuntimeParent(_jettag_c_if_70_1);
            _jettag_c_get_83_91.setTagInfo(_td_c_get_83_91);
            _jettag_c_get_83_91.doStart(context, out);
            _jettag_c_get_83_91.doEnd();
            out.write("\" ");  //$NON-NLS-1$        
            out.write(NL);         
            out.write(NL);         
        ...
        out.write(NL);         
        RuntimeTagElement _jettag_c_choose_102_1 = context.getTagFactory().createRuntimeTag(_jetns_c, "choose", "c:choose", _td_c_choose_102_1); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_choose_102_1.setRuntimeParent(null);
        _jettag_c_choose_102_1.setTagInfo(_td_c_choose_102_1);
        _jettag_c_choose_102_1.doStart(context, out);
        JET2Writer _jettag_c_choose_102_1_saved_out = out;
        while (_jettag_c_choose_102_1.okToProcessBody()) {
            ...
            _jettag_c_when_103_1.setRuntimeParent(_jettag_c_choose_102_1);
            ...
            while (_jettag_c_when_103_1.okToProcessBody()) {
                ...
                out.write(NL);         
                out.write("      <connections xmi:type=\"eflow:FCMConnection\" xmi:id=\"FCMConnection_5\" targetNode=\"FCMComposite_1_5\" sourceNode=\"FCMComposite_1_8\" sourceTerminalName=\"OutTerminal.failure\" targetTerminalName=\"InTerminal.in\"/>");  //$NON-NLS-1$        
                out.write(NL);         
                out.write("      <connections xmi:type=\"eflow:FCMConnection\" xmi:id=\"FCMConnection_9\" targetNode=\"FCMComposite_1_5\" sourceNode=\"FCMComposite_1_8\" sourceTerminalName=\"OutTerminal.unknown\" targetTerminalName=\"InTerminal.in\"/>");  //$NON-NLS-1$        
                out.write(NL);         
                out.write("      <connections xmi:type=\"eflow:FCMConnection\" xmi:id=\"FCMConnection_10\" targetNode=\"FCMComposite_1_5\" sourceNode=\"FCMComposite_1_8\" sourceTerminalName=\"OutTerminal.false\" targetTerminalName=\"InTerminal.in\"/>");  //$NON-NLS-1$        
                out.write(NL);         
                out.write("      <connections xmi:type=\"eflow:FCMConnection\" xmi:id=\"FCMConnection_19\" targetNode=\"FCMComposite_1_5\" sourceNode=\"FCMComposite_1_12\" sourceTerminalName=\"OutTerminal.failure\" targetTerminalName=\"InTerminal.in\"/>");  //$NON-NLS-1$        
                out.write(NL);         
                out.write("      <connections xmi:type=\"eflow:FCMConnection\" xmi:id=\"FCMConnection_20\" targetNode=\"FCMComposite_1_5\" sourceNode=\"FCMComposite_1_12\" sourceTerminalName=\"OutTerminal.out\" targetTerminalName=\"InTerminal.in\"/>");  //$NON-NLS-1$        
                out.write(NL);         
                _jettag_c_when_103_1.handleBodyContent(out);
            }
            out = _jettag_c_when_103_1_saved_out;
            _jettag_c_when_103_1.doEnd();
            RuntimeTagElement _jettag_c_otherwise_119_1 = context.getTagFactory().createRuntimeTag(_jetns_c, "otherwise", "c:otherwise", _td_c_otherwise_119_1); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_otherwise_119_1.setRuntimeParent(_jettag_c_choose_102_1);
            _jettag_c_otherwise_119_1.setTagInfo(_td_c_otherwise_119_1);
            _jettag_c_otherwise_119_1.doStart(context, out);
            JET2Writer _jettag_c_otherwise_119_1_saved_out = out;
            while (_jettag_c_otherwise_119_1.okToProcessBody()) {
                out = out.newNestedContentWriter();
                out.write("      <connections xmi:type=\"eflow:FCMConnection\" xmi:id=\"FCMConnection_5\" targetNode=\"FCMComposite_1_5\"");  //$NON-NLS-1$        
                out.write(NL);         
                out.write("      sourceNode=\"FCMComposite_1_3\" sourceTerminalName=\"OutTerminal.second\" ");  //$NON-NLS-1$        
                out.write(NL);         
                out.write("      targetTerminalName=\"InTerminal.in\"/>");  //$NON-NLS-1$        
                out.write(NL);         
                _jettag_c_otherwise_119_1.handleBodyContent(out);
            }
            out = _jettag_c_otherwise_119_1_saved_out;
            _jettag_c_otherwise_119_1.doEnd();
            _jettag_c_choose_102_1.handleBodyContent(out);
        }
        out = _jettag_c_choose_102_1_saved_out;
        _jettag_c_choose_102_1.doEnd();
        out.write("      ");  //$NON-NLS-1$        
        out.write(NL);         
        out.write(NL);         
        out.write(NL);         
        ...
        out.write(NL);         
        RuntimeTagElement _jettag_c_if_130_9 = context.getTagFactory().createRuntimeTag(_jetns_c, "if", "c:if", _td_c_if_130_9); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_if_130_9.setRuntimeParent(null);
        _jettag_c_if_130_9.setTagInfo(_td_c_if_130_9);
        _jettag_c_if_130_9.doStart(context, out);
        while (_jettag_c_if_130_9.okToProcessBody()) {
            ...
            out.write(NL);         
            out.write("        bundleName= \"");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_c_get_134_22 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_134_22); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_134_22.setRuntimeParent(_jettag_c_if_130_9);
            _jettag_c_get_134_22.setTagInfo(_td_c_get_134_22);
            _jettag_c_get_134_22.doStart(context, out);
            _jettag_c_get_134_22.doEnd();
            RuntimeTagElement _jettag_c_get_134_60 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_134_60); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_134_60.setRuntimeParent(_jettag_c_if_130_9);
            _jettag_c_get_134_60.setTagInfo(_td_c_get_134_60);
            _jettag_c_get_134_60.doStart(context, out);
            _jettag_c_get_134_60.doEnd();
            out.write("\" ");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("        pluginId=\"");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_c_get_135_19 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_135_19); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_135_19.setRuntimeParent(_jettag_c_if_130_9);
            _jettag_c_get_135_19.setTagInfo(_td_c_get_135_19);
            _jettag_c_get_135_19.doStart(context, out);
            _jettag_c_get_135_19.doEnd();
            out.write("\"/>");  //$NON-NLS-1$        
            out.write(NL);         
            out.write("      </propertyDescriptor>    ");  //$NON-NLS-1$        
            out.write(NL);         
            _jettag_c_if_130_9.handleBodyContent(out);
        }
        _jettag_c_if_130_9.doEnd();
        out.write("    </propertyOrganizer>");  //$NON-NLS-1$        
        out.write(NL);         
