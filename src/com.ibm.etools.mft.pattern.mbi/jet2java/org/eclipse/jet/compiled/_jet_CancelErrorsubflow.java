...
public class _jet_CancelErrorsubflow implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_CancelErrorsubflow() {
        super();
    }
    ...
    private static final TagInfo _td_c_if_96_17 = new TagInfo("c:if", //$NON-NLS-1$
            96, 17,
            new String[] {
                "test", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_100_23 = new TagInfo("c:get", //$NON-NLS-1$
            100, 23,
            new String[] {
                "select", //$NON-NLS-1$
            },
...
com.ibm.etools.mft.pattern.mbi.ms.xmlmq.PatternMessages messages = new com.ibm.etools.mft.pattern.mbi.ms.xmlmq.PatternMessages();
        ...
        out.write(NL);         
        out.write(NL);         
        RuntimeTagElement _jettag_c_if_96_17 = context.getTagFactory().createRuntimeTag(_jetns_c, "if", "c:if", _td_c_if_96_17); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_if_96_17.setRuntimeParent(null);
        _jettag_c_if_96_17.setTagInfo(_td_c_if_96_17);
        _jettag_c_if_96_17.doStart(context, out);
        while (_jettag_c_if_96_17.okToProcessBody()) {
            ...
            _jettag_c_get_99_19.setRuntimeParent(_jettag_c_if_96_17);
            ...
            out.write(NL);         
            out.write("            pluginId=\"");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_c_get_100_23 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_100_23); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_100_23.setRuntimeParent(_jettag_c_if_96_17);
            _jettag_c_get_100_23.setTagInfo(_td_c_get_100_23);
            _jettag_c_get_100_23.doStart(context, out);
            _jettag_c_get_100_23.doEnd();
            out.write("\"/></propertyDescriptor>");  //$NON-NLS-1$        
            out.write(NL);         
            _jettag_c_if_96_17.handleBodyContent(out);
        }
        _jettag_c_if_96_17.doEnd();
        out.write(NL);         
        out.write("         </propertyOrganizer>");  //$NON-NLS-1$        
        out.write(NL);         
