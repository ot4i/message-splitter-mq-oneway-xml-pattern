...
public class _jet_Intermediaryesql_0 implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_Intermediaryesql_0() {
        super();
    }
...
com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.PatternMessages messages = new com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.PatternMessages();
        ...
        out.write( pattern.getString("com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.esql.2") );
        out.write("');");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write( pattern.getString("com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.esql.3") );
        out.write("';");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write(NL);         
        out.write("\t\tSET reasonStr = '");  //$NON-NLS-1$        
        out.write( pattern.getString("com.ibm.etools.mft.pattern.mbi.mrrc.synchmq.esql.4") );
        out.write("';");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tTHROW USER EXCEPTION SEVERITY 3 MESSAGE 2372 VALUES(reasonStr);");  //$NON-NLS-1$        
        out.write(NL);         
